...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrapselect@1.13.9/dist/css/bootstrap-select.min.css">
 <!-- Vendor CSS Files -->
...
<nav class="header-nav ms-auto">
 ...
 <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bstoggle="dropdown">
 <img src="{{ asset('assets/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle">
 <span class="d-none d-md-block ps-2">ANONYMOUS</span>
...
href="#">
 <i class="bi bi-menu-button-wide"></i><span>Components</span><i class="bi bi-chevrondown ms-auto"></i>
 </a>
 ...
 <i class="bi bi-journal-text"></i><span>Transaksi</span><i class="bi bi-chevron-down msauto"></i>
 </a>
...
<li class="nav-item">
 ...
 <i class="bi bi-layout-text-window-reverse"></i><span>Laporan</span><i class="bi bi-chevrondown ms-auto"></i>
 </a>
 ...
 <i class="bi bi-bar-chart"></i><span>Manajemen</span><i class="bi bi-chevron-down msauto"></i>
 </a>
 ...
 <div class="copyright">
 &copy; Copyright <strong><span>1945</span></strong>. All Rights Reserved
 </div>
 <div class="credits"> Designed by <a href="">civil </a>
 </div>
 </footer> -->
 <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi biarrow-up-short"></i></a>
...
crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.9/dist/js/bootstrapselect.min.js"></script> --}}
 <script>
