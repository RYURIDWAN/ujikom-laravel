                        ...
                        <div class="animated fadeIn">
                            ...
                            <div class="card-header">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td><h5 class="card-title">Data Jenis Barang</h5></td>
                                        <td>
                                            <div align="right">
                                                ...
                                                <a href="{{ url('impjenis') }}" class="btn btn-success btn-sm" role="button" aria-disabled="true">
                                                    <span class="bi bi-upload" style="font-size:16px"> Import Data</span>
                                                </a>
                                                <a href="{{ url('expjenis') }}" class="btn btn-success btn-sm" role="button" aria-disabled="true">
                                                    <span class="bi bi-file-earmark-excel" style="font-size:16px"> Export Data</span>
                                                </a>
